...
const typeDefs = gql`
  ...
  type Mutation {
    ...
    createUser(name: String!, email: String!, role: Role!, password:String!): User
...
const resolvers = {
  Query: {
    ...
    faculties: makeResolver((root, args, context) =>
      users.filterUsers("Faculty")
    ),
  ...
  Mutation: {
    ...
    createUser: (root, args, context) =>
      users.create(args.name, args.email, args.role, args.password),
